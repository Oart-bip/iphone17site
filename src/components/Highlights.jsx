function Highlights() {
    // space-y-3: coloca um margin block e adiciona espaçamento automatico
    return (
        <section className="bg-black py-20 px-6" id="design">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-8 mb-16">
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img
                            ...
                            src="/img/titanium-design (1).jpg"
                            alt="iPhone em titânio"
                        />
                    ...
                    <div className="bg-gray-900 rounded-exl p-8">
                        <img
                            className=" w-full rounded-2xl mb-4"
                            src="/img/ios-features (1).jpg"
                            alt="ios 2025"
                        />
                ...
                <div className="bg-gray-900 rounded-3xl p-12 mb-16" id="perfomance">
                    ...
                    <img className="w-full" src="/img/chip-a18-pro (1).jpg" alt="chip a18" />
                ...
                <div id="camera" className="text-center">
                    ...
                    <div className="grid grid-cols-3 gap-6">
                        <div className="bg-gray-900 rounded-2xl p-8 hover:scale-105 cursos-pointer transition-all duration-300">
